---
layout: post
title: Customer Segmentation for a supermarket chain based on shopping behavior
image: "/posts/clustering-title-img.png"
tags: [Customer Segmentation, Machine Learning, Clustering, Python]
---

This project segments supermarket customers based on their spending behavior across major food categories using K-Means clustering. By analyzing six months of transaction data, we identified three distinct customer groups that suggest dietary preferences like omnivore, vegetarian, and vegan. The insights support more targeted marketing and deeper customer understanding, forming the foundation of the "You Are What You Eat" segmentation.
...
- [K-Means ↩](#k-means-)
  ...
  - [Append Clusters To Customers ](#append-clusters-to-customers-)
...
The senior management team of a supermarket chain had conflicting views about how customer lifestyle choices influence shopping patterns. They asked us to use data and machine learning to segment their customers based on how they engage with key food categories. This segmentation is intended to improve customer understanding and enable more personalized marketing and communication.

## Objective

Segment customers based on their spending behavior across major food categories, uncovering possible dietary preferences (e.g., omnivore, vegetarian, vegan) to support more relevant and targeted business strategies.
...
## Application [↩](#kmeans-application)
