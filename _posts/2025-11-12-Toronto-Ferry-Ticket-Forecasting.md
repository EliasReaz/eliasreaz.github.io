...
image: "/img/posts/toronto-islands-cropped.png"
...
![Daily redemption count from 2022 onwards](/img/posts/daily_redemption_count_2022_onwards.png)
...
![Log-transformation](/img/posts/log_transformed_redemption_counts.png)
*Figure: log-transformed daily redemption stabilizes the variance.

### First differencing of log-transformed series
![First difference](/img/posts/first_differencing_of_logtransformed_series.png)
...
### ACF and PACF plots
![ACF and PACF plot](/img/posts/acf_pacf_first_diff_of_logtransformed_data.png)
...
![sarima plot diagnostics](/img/posts/residual_plot_diagnostic.png)
...
```
![prophet forecasting](/img/posts/prophet_fold_4.png)
...
![Dagshub](/img/posts/dagshub_screenshot_sarima.png)
